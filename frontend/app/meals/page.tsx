...
export default function MealsPage() {
  ...
  async function fetchSaved() {
    try {
      const res  = await fetch(`https://pocketpal-production-6074.up.railway.app/meals/saved?user_id=${USER_ID}`);
  ...
  async function suggest() {
    ...
    setTab("suggest");
    try {
      const res  = await fetch("https://pocketpal-production-6074.up.railway.app/meals/suggest", {
        method: "POST",
  ...
  async function saveMeal(meal: Meal) {
    ...
    try {
      await fetch("https://pocketpal-production-6074.up.railway.app/meals/save", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function deleteMeal(name: string) {
    try {
      await fetch("https://pocketpal-production-6074.up.railway.app/meals/delete", {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
